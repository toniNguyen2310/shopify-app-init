...
import TemplateVisibilitySection from "app/components/TemplateVisibilitySection/TemplateVisibilitySection";
    ...
    return (
        <>
            <Page
                ...
                title={mode === 'create' ? 'Add page' : ` ${formState.title}`}
                secondaryActions={mode === "edit"
                    ? [
                        ...
                        {
                            content: "Preview",
                            disabled: isNavigate || isLoading,
                            onAction: () => {
                                const pageId = formState.id; // Lấy ID từ initialState
                                if (pageId) {
                                    setIsNavigate(true)
                                    navigate(`/app/preview/${pageId}`);
                                }
                            },
                        },
